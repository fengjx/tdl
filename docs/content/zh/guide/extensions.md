...
如果你遇到任何问题或有任何建议，请在 GitHub 上[创建 Issue](https://github.com/fengjx/tdl/issues/new/choose)。
{{< /hint >}}
...
你可以看到 `tdl-whoami` 扩展的输出。详情请参阅 [tdl-whoami](https://github.com/fengjx/tdl-whoami)。
```
...
请参阅 [tdl-extension-template](https://github.com/fengjx/tdl-extension-template) 代码库，了解如何为 tdl 创建、构建和发布扩展。
